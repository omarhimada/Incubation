...
public sealed class Incubate(ITrainingDataStorage trainingDataStorage) {
	private readonly ITrainingDataStorage _trainingDataStorage = trainingDataStorage;
	...
	public async Task GenerateData() {
		...
		foreach (Customer customer in customers) {
			...
			customer.NumberOfCustomerServiceCalls = Math.Clamp(_random.NextPoisson(supportBase), 0, 40);
